...
function deriveState(currentStep: DemoStep, recoverySettled: boolean): DemoDerivedState {
  // Mock WCS state machine. Replace this adapter with real WCS / PLC / RCS
  // state mapping when the demo is connected to live systems.
...
export default function App() {
  ...
  }, [currentStep, isLoop, isPlaying, setStepWithLogs]);
